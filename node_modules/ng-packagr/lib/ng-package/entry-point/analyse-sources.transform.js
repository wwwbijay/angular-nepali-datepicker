...
function analyseEntryPoint(graph, entryPoint, entryPoints) {
    ...
    compilerHost.resolveTypeReferenceDirectives = (moduleNames, containingFile, redirectedReference, options) => {
        return moduleNames.map(moduleName => {
            ...
            const result = typescript_1.default.resolveTypeReferenceDirective(moduleName, (0, path_1.ensureUnixPath)(containingFile), options, compilerHost, redirectedReference).resolvedTypeReferenceDirective;
            return result;
        });
    };
    compilerHost.resolveModuleNames = (moduleNames, containingFile, _reusedNames, redirectedReference, options) => {
        return moduleNames.map(moduleName => {
            ...
            const { resolvedModule } = typescript_1.default.resolveModuleName(moduleName, (0, path_1.ensureUnixPath)(containingFile), options, compilerHost, moduleResolutionCache, redirectedReference);

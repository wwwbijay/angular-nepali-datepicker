...
class NgPackagr {
     ...
     */
    build(options = {}) {
        this.providers.push((0, options_di_1.provideOptions)({ ...options, watch: false }));
    ...
    buildAsObservable() {
        ...
        return (0, rxjs_1.of)(new build_graph_1.BuildGraph()).pipe(buildTransformOperator, (0, operators_1.mapTo)(undefined));
    }
}
